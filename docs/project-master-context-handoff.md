...
- Homework upload/review foundation SQL/storage/RLS draft now exists at `supabase/sql/014_homework_upload_review_foundation.sql` (manual/dev-first; not applied yet; runtime/UI wiring still pending).

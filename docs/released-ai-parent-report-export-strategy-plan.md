...
| **PDF export** | **Not implemented** for parents (no file download). **ParentView** optional **Preview printable report** (iframe, same released content) — **`docs/parent-view-printable-report-preview-checkpoint.md`**. |

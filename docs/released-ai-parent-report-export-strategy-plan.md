...
| **PDF export** | **Not implemented** for parents (no file download). **ParentView** optional **Preview printable report** (iframe, same released content) — **`docs/parent-view-printable-report-preview-checkpoint.md`**, visual polish **`docs/parent-view-printable-report-preview-visual-polish-checkpoint.md`**, final seal **`docs/parent-view-printable-report-preview-final-checkpoint.md`**. **Manual visual QA before Download PDF / storage:** **`docs/manual-qa-parent-view-printable-report-preview-checkpoint.md`**. |
